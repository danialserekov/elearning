...
function Sidebar() {
  ...
  <nav className="navbar navbar-expand-md shadow-sm mb-4 mb-lg-0 sidenav bg-light rounded">
    <a
      className="d-xl-none d-lg-none d-md-none text-dark fw-bold text-decoration-none p-3"
      href="#"
    >
      Menu
    </a>
    ...
    <div className="collapse navbar-collapse p-3" id="sidenav">
      <div className="navbar-nav flex-column">
        ...
        {/* Navbar header */}
        <span className="navbar-header mb-3 text-muted fw-bold">Account Settings</span>
